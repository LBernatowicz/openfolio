    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pt-24">
        <div className="text-center py-16">
          <h2 className="text-4xl font-bold text-white mb-4">Moje Portfolio</h2>
          <p className="text-gray-400 text-lg mb-8">Wkrótce znajdziesz tutaj wszystkie moje prace</p>
